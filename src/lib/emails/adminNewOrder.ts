export const adminNewOrderEmail = (orderId: string, customerName: string, customerEmail: string, products: any[], totalAmount: number) => {
    return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
      ...
      <body>
          <div class="container">
              <div class="header">
                  <h1>🔔 New Sale on NexaStore!</h1>
              </div>
              <div class="content">
                  <p>Congratulations! You have received a new order on NexaStore.</p>
              ...
              <div class="footer">
                  <p>© 2024 NexaStore. Admin Notification Panel.</p>
              </div>
          </div>
      </body>
      </html>
