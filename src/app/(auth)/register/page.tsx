         ...
         >
            <div className="glass p-10 md:p-14 shadow-2xl bg-[#1E293B]/70 border-white/5 relative overflow-hidden group">
               ...
               <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="pt-8 text-center text-[10px] font-bold text-slate-600 uppercase tracking-widest bg-white/5 p-4 rounded-2xl border border-white/5 font-mono">
                     Social registration is currently locked
                  </div>
